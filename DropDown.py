...
DEFAULT_TEXTCOLOR_LIGHTMODE = ft.Colors.BLACK
...
# - Disabled Colors
DEFAULT_DISABLED_BORDER_DARKMODE = ft.border.all(width=1, color='white,0.04')
DEFAULT_DISABLED_BORDER_LIGHTMODE = ft.border.all(width=0.5, color=ft.Colors.GREY_400)
DEFAULT_DISABLED_TEXTCOLOR_DARKMODE = ft.Colors.WHITE30
DEFAULT_DISABLED_TEXTCOLOR_LIGHTMODE = ft.Colors.BLACK26
DEFAULT_DISABLED_TEXTSTYLE_DARKMODE = ft.TextStyle(size=15, color= DEFAULT_DISABLED_TEXTCOLOR_DARKMODE)
DEFAULT_DISABLED_TEXTSTYLE_LIGHTMODE = ft.TextStyle(size=15, color= DEFAULT_DISABLED_TEXTCOLOR_LIGHTMODE)
# - Other Parameters
        ...
        if self.page:
            if self.page.theme_mode == ft.ThemeMode.LIGHT:
                if self.disabled == True:
                    self.showing_container.border = DEFAULT_DISABLED_BORDER_LIGHTMODE
                    self.text_display.style = DEFAULT_DISABLED_TEXTSTYLE_LIGHTMODE
                    self.gesture.mouse_cursor = None
                else:
                    self.showing_container.border = DEFAULT_BORDER_LIGHTMODE
                    self.text_display.style = DEFAULT_TEXTSTYLE_LIGHTMODE
                    self.gesture.mouse_cursor = ft.MouseCursor.CLICK
            else:
                if self.disabled == True:
                    self.showing_container.border = DEFAULT_DISABLED_BORDER_DARKMODE
                    self.text_display.style = DEFAULT_DISABLED_TEXTSTYLE_DARKMODE
                    self.gesture.mouse_cursor = None
                else:
